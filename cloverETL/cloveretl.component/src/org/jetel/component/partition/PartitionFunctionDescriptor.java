...
/**
 * Factorisation descriptor for {@link PartitionFunction} class.
 * 
...
public class PartitionFunctionDescriptor implements TransformDescriptor<PartitionFunction> {
	...
	@Override
	public PartitionFunction createInterpretedCTL2Transform(TransformLangExecutor executor, Logger logger) {
		return new CTLRecordPartitionAdapter(executor, logger);
	}
