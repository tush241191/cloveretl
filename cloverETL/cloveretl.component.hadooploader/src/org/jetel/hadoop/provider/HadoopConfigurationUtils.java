...
public class HadoopConfigurationUtils {
	 ...
	 * representation of key/value pairs given as argument.
	 * 
	 * @param properties Properties to be translated into Hadoop specific configuration. If <code>null</code> empty
	 *        configuration is returned.
	 * @return Configuration holding representation of given properties.
	 * @see Properties
	 * @see Configuration
	 */
