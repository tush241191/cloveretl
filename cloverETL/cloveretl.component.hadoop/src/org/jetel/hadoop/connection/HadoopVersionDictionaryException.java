...
//	public HadoopVersionDictionaryException() {
//		super();
//	}

	public HadoopVersionDictionaryException(String message, Throwable cause) {
		super(message, cause);
	}

	public HadoopVersionDictionaryException(String message) {
		super(message);
	}

	//TODO add that constructor to superclass and here
//	public HadoopVersionDictionaryException(Throwable cause) {
//		super(cause);
//	}
}
